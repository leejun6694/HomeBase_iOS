...
extension SignUpViewController {
    ...
    private func pwConditionImageViewConstraints() -> [NSLayoutConstraint] {
        ...
        let heightConstraint = NSLayoutConstraint(
            ...
            toItem: pwConditionImageView, attribute: .width, multiplier: 18.0/20.0, constant: 0.0)
    ...
    private func confirmPwConditionImageViewConstraints() -> [NSLayoutConstraint] {
        ...
        let heightConstraint = NSLayoutConstraint(
            ...
            toItem: confirmPwConditionImageView, attribute: .width, multiplier: 18.0/20.0, constant: 0.0)
